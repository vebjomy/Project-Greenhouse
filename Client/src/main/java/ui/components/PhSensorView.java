...
/**
 * Visual component for displaying pH sensor readings in a modern card style with a horizontal pH
 * spectrum bar and a context menu button for deletion.
 *
...
public class PhSensorView {
  ...
  public static Pane create(String name, double value, String unit) {
    ...
    double neutralWidth = BAR_WIDTH * ((PH_ALKALINE_THRESHOLD - PH_ACIDIC_THRESHOLD)
        / PH_MAX); // (7.5-6.0)/14.0 * 210
    double alkalineWidth =
        BAR_WIDTH * ((PH_MAX - PH_ALKALINE_THRESHOLD) / PH_MAX); // (14-7.5)/14.0 * 210
