...
/**
 * Manages the connection to the SQLite database for storing and retrieving sensor data.
 * This class is responsible for establishing a connection and creating necessary tables.
 */
